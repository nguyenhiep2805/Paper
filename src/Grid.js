...
export default class Grid extends Component {
      ...
      grid:
        ...
        window.encodeURIComponent(
          '<svg width="' +
            ...
            distanceY +
            unit +
            '" viewPort="0 0 5mm 5mm" xmlns="http://www.w3.org/2000/svg"> <line x1="' +
            quaterX +
            unit +
            '" y1="' +
            0 +
  ...
  drawLines(distance, unit, colour) {
    this.setState({
      grid:
        'data:image/svg+xml;charset=UTF-8,' +
        window.encodeURIComponent(
          '<svg width="5mm" height="' +
            distance +
            unit +
            '" viewPort="0 0 5mm 5mm" xmlns="http://www.w3.org/2000/svg"> <line x1="0mm" y1="4mm" x2="5mm" y2="4mm" stroke-width="0.3mm" stroke="' +
            colour +
            '"/> </svg>'
        ),
    });
      ...
      grid:
        ...
        window.encodeURIComponent(
          '<svg width="' +
            ...
            'mm" height="' +
            distanceMM +
            'mm" viewPort="0 0 5mm 5mm" xmlns="http://www.w3.org/2000/svg"> <line x1="0mm" y1="' +
            adjustedDistance +
            'mm" x2="' +
            distanceMM +
            'mm" y2="' +
            adjustedDistance +
            'mm" stroke-width="0.3mm" stroke="' +
            colour +
            '"/> <line x1="' +
            adjustedDistance +
            'mm" y1="0mm" x2="' +
  ...
  drawNotes(distance, unit, colour, staffNr) {
    ...
    const distanceY =
      unit === 'mm'
        ? distance + 15 * staffNr - 8.5
        : distance / 0.03937 + 15 * staffNr - 8.5;
      ...
      grid:
        ...
        window.encodeURIComponent(
          '<svg width="' +
            ...
            '" height="' +
            distanceY +
            'mm" viewPort="0 0 5mm 10mm" xmlns="http://www.w3.org/2000/svg">' +
            grid +
            '</svg>'
        ),
    });
